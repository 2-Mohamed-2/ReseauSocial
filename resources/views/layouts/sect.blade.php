                                                                            ...
                                                                            <div class="form-group has-icon-left">
                                                                                <div class="position-relative">
                                                                                    <select class="form-control" name="commissariat_id">
                                                                                        @php
                                                                                            $daou = $sect->commissariat_id; 
                                                                                            $us = App\Models\Commissariat::find($daou);
                                                                                        @endphp
                                                                                        <option value="{{ $us->id }}"> {{ $us->libelle }} </option>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form action="{{route('Section.destroy', $sect->id)}}"
                                                                ...
                                                                <div class="form-body">
                                                                    <p>
                                                                        Êtes-vous sur de vouloir supprimé la
                                                                        section : {{$sect->libelle}} ?
                                                                    </p>
                                                                </div>
