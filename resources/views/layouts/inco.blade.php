                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p class="text-wrap">
                                                            <form method="POST"
                                                                action="{{route('Inconnu.update', $inco->id)}}">
                                                                @method('PUT')
                                                                @csrf
                                                                <div class="form-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group has-icon-left">
                                                                                <small
                                                                                    class="text-muted"><i>Genre</i></small>
                                                                                <div class="position-relative">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group has-icon-left">
                                                                                <small
                                                                                    class="text-muted"><i>Motif</i></small>
                                                                                <div class="position-relative">
                                                                                    <input type="text"
                                                                                        autocomplete="off" name="motif"
                                                                                        class="form-control"
                                                                                        value="{{$inco->motif}}"
                                                                                        placeholder="....">
                                                                                    <div class="form-control-icon">
                                            ...
                                            <div class="modal fade admin-query" id="incoDestroy{{$inco->id}}"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p class="text-wrap">
                                                            <form action="{{route('Inconnu.destroy', $inco->id)}}"
                                                                method="POST">
                                                                @method("DELETE")
                                                                @csrf
                                                                <div class="form-body">
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-icon-left">
                                    <div class="position-relative">
                                        <input type="text" autocomplete="off" name="motif" class="form-control" value=""
                                            placeholder="Motif !...">
                                        <div class="form-control-icon">
                                            <i class="bi bi-pencil"></i>
                                        </div>
