...
<div class="card-body">
    <p class="card-text">Pour <a href="" data-bs-toggle="modal" data-bs-target="#graAdd">insérer une nouvelle ligne</a></p>
        ...
        <table class="table table-lg">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#graUpdate{{$gra->id}}"
                            href="#">
                            Modifier
                        </a>
                    </td>
                    <td>
                        <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#graDestroy{{$gra->id}}"
                            href="#">
                            Supprimer
                        </a>
                    </td>
                ...
                <div class="modal fade admin-query" id="graUpdate{{$gra->id}}" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true"  role="dialog" tabindex="-1">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p class="text-wrap">
                                    <form action="{{route('Grade.update', $gra->id)}}" method="POST">
                                        @method('PUT')
                                        @csrf
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group has-icon-left">
                                                        <div class="position-relative">
                                                            ...
                                                            class="form-control" value="{{$gra->libelle}}" placeholder="....">
                ...
                <div class="modal fade admin-query" id="graDestroy{{$gra->id}}" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true"  role="dialog" tabindex="-1">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p class="text-wrap">
                                    <form action="{{route('Grade.destroy', $gra->id)}}" method="POST">
                                        @method("DELETE")
                                        @csrf
                                        <div class="form-body">
                                            <p>
                                                Êtes-vous sur de vouloir supprimé se grade du : {{$gra->libelle}} ?
                                            </p>
                                        </div>
...
<div class="modal fade admin-query" id="graAdd" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true"  role="dialog" tabindex="-1">
<div class="modal-dialog" role="document">
<div class="modal-content">
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group has-icon-left">
            <div class="position-relative">
                <input type="text" autocomplete="off" name="libelle"
                class="form-control" value="" placeholder="Nom du grade !...">
                <div class="form-control-icon">
                    <i class="bi bi-pencil"></i>
                </div>
            </div>
