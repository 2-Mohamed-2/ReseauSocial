                                                    ...
                                                    <div class="row">
                                                        ...
                                                        {{-- <div class="col-md-6">
                                                            <div class="form-group has-icon-left">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group has-icon-left">
                                                                        <small class="text-muted"><i>ne_le</i></small>
                                                                        <div class="position-relative">
                                                                            <input type="text"
                                                                            autocomplete="off"
                                                                            name="ne_le"
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-icon-left">
                                    <div class="position-relative">
                                        <input type="text" autocomplete="off" name="ne_le"
                                        class="form-control" value="" placeholder="Date de naissance !...">
                                        <div class="form-control-icon">
                                            <i class="bi bi-pencil"></i>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-icon-left">
                                    <div class="position-relative">
                                        ...
                                        class="form-control" value="" placeholder="Lieu de naissance !...">
                                        <div class="form-control-icon">
                                            <i class="bi bi-pencil"></i>
                                        </div>
                                    </div>
