    ...
    <div class="form-body">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group has-icon-left">
                    <div class="position-relative">
                        <input type="text" autocomplete="off" name="nomcomplet" class="form-control" value=""
            ...
            <div class="col-md-12">
                <div class="form-group has-icon-left">
                    <div class="position-relative">
                        <input type="text" autocomplete="off" name="adresse" class="form-control" value=""
                            placeholder="Adresse!...">
                        <div class="form-control-icon">
                            <i class="bi bi-pencil"></i>
                        </div>
